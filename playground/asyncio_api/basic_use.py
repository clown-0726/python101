...
"""
Python3.4 之后提供的标准协程库，提供丰富的协程接口
"""
...
"""定义 task 任务
可以使用 asyncio.ensure_future 定义，也可以使用 loop.create_task 进行定义
...
"""定义任务组
可以使用 wait 方法等待一个任务组的完成
也可以使用 gather 方法，其是比 wait 更高的功能抽象，可以对任务进行分组，也可以取消某个组的任务执行
"""
